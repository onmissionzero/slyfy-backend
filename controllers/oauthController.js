...
const callback = async (req, res) => {
  try {
    ...
    res.cookie('jwt_access_token', JWTAccessToken, { httpOnly: true, sameSite: 'lax', secure: false, maxAge: 60 * 60 * 1000 });
    res.cookie('jwt_refresh_token', JWTRefreshToken, { httpOnly: true, sameSite: 'lax', secure: false, maxAge: 3 * 24 * 60 * 60 * 1000 });
